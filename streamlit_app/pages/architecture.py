...
("GitHub Actions CI",
 "Automated pytest runs on every push — 5 unit tests validate the Bayesian A/B testing engine.",
...
<div style="display:flex; align-items:center; gap:0.5rem; margin-bottom:0.6rem;">
                ...
                {'<a href="https://github.com/jfan4926/E-Commerce-Analytics/actions" target="_blank"><img src="https://github.com/jfan4926/E-Commerce-Analytics/actions/workflows/ci.yml/badge.svg?branch=streamlit-deploy" style="vertical-align:middle;"/></a>' if title == "GitHub Actions CI" else ''}
            </div>
